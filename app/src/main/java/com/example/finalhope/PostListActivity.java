...
//        eventsLayout = findViewById(R.id.eventsLayout);
        ...
        drawerLayout = findViewById(R.id.drawer_layout_postList);
        navigationView = findViewById(R.id.nav_view_postList);
        toolbar = findViewById(R.id.toolbar_postList);
    ...
    protected void onStart() {
        ...
        databaseEvents.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                PostList posAdapter = new PostList(PostListActivity.this, events);
